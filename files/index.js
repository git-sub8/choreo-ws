...
const UUID = process.env.UUID || '1b242977-6f9e-4297-ac69-6a25d03589d5'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'FzvTjyranvEtBvUT22 ';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.vps-jdkz.gq';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
